...
def products(request):
	...
	laptop=Product.objects.filter(product_category="Laptop")
	camera=Product.objects.filter(product_category="Camera")
	accessories=Product.objects.filter(product_category="Accessories")
	laptop_count=len(laptop)
	camera_count=len(camera)
	accessories_count=len(accessories)
	return render(request,'store.html',{'products':products,'laptop_count':laptop_count,'camera_count':camera_count,'accessories_count':accessories_count})
...
def by_category(request,pc):
	...
	return render(request,'by_category.html',{'products':products,'product_count':product_count})
